	...
	return (
		<div className="min-h-screen bg-background pb-20">
			<div className="container mx-auto max-w-4xl px-6 py-10">
				...
				<div ref={captureRef} className="rounded-3xl bg-card p-8 shadow-xl shadow-muted/50 border border-border">
					<div className="text-center mb-12">
						<div className="inline-flex items-center justify-center p-3 bg-red-500/10 rounded-full mb-4">
							<Heart weight="fill" className="w-8 h-8 text-red-500" />
						</div> 
						<h1 className="font-display text-4xl font-bold text-foreground">
							The best cofounder for <br />
							<span className="text-muted-foreground">@{tg1Data.username}</span> is...
						</h1>
					</div>
						...
						<div className="grid md:grid-cols-2 gap-12 relative z-10">
							...
							<div className="flex flex-col items-center">
								<div className="relative mb-6">
									...
									/>
									<div className="absolute -bottom-3 -right-3 bg-primary text-primary-foreground p-2 rounded-xl shadow-md">
							...
							<div className="flex flex-col items-center">
								...
								<div className="mt-2 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/10 text-blue-600 dark:text-blue-400 text-sm font-medium border border-blue-500/20">
					...
					<div className="mt-12 p-6 bg-muted/30 rounded-2xl border border-border text-center">
